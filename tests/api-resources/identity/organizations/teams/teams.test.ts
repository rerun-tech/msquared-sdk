...
describe('resource teams', () => {
  test('delete', async () => {
    const responsePromise = client.identity.organizations.teams.delete('organizationId', 'teamId');
  ...
  test('delete: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.identity.organizations.teams.delete('organizationId', 'teamId', {
