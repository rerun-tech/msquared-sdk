...
describe('resource teams', () => {
  test('create: only required params', async () => {
    const responsePromise = client.organizations.teams.create('organizationId', 'teamId', { name: 'name' });
  ...
  test('create: required and optional params', async () => {
    const response = await client.organizations.teams.create('organizationId', 'teamId', { name: 'name' });
  });
