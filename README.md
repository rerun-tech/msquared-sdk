...
This can also be useful if you are getting the wrong TypeScript types for `Response` ([more details](https://github.com/rerun-tech/msquared-sdk/tree/main/src/_shims#readme)).
...
We are keen for your feedback; please open an [issue](https://www.github.com/rerun-tech/msquared-sdk/issues) with questions, bugs, or suggestions.
